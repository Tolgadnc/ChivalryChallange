        ...
        while (true) {
            ...
            //direction commands to the player (N,S,E,W)
                ...
                case "go west":
                    ...
                    break;
               /*look around to find what type of villain area(description), this works as if  the the player current coordinates and villain coordinates is
                  equal the "LOOK" command works and describes about the vilain*/ 
                case "look":
                ...
                case "attack":
                		...
                		/* In this loop it shows that if the player reaches the same coordinates again and tries to find an dead opponent
                		 * Villain wind*/
                        if (hero.getInventory().contains(singleHandedSword)){
                           ...
                           // same loop for the double handed sword
                ...
                case "drink compound potion":
                    if (hero.getHealthPoints() < 20 && hero.getStaminaPoints() < 20){
                        hero.consumePotion(compoundPotion, hero);
                        hero.remove(compoundPotion);
                        hero.displayStats();
                    }else if (hero.getHealthPoints() == 20 && hero.getStaminaPoints() < 20){
                        hero.consumePotion(compoundPotion, hero);
                        hero.remove(compoundPotion);
                        hero.displayStats();
            ...
            //when all the villains are dead it intiates the boss fight after the regular villain dies
