...
public class Game {
    ...
    private static Hero hero = new Hero(0, 100000,100000 ,preparingArea);
    ...
    private static VillainRegular villainRegularSnow = new VillainRegular("Arctic Range", "a woman. Se is clad in insulated, fur-trimmed garments, blending seamlessly with the wintry surroundings. Armed with a double-bladed ice axe for climbing and combat, he moves silently through the snow-covered trees, agile and prepared for frigid encounters. She feels your presence. You must fight, so you can move on!", 2,3,10,1,2,1);
    private static VillainRegular villainRegularDesert = new VillainRegular("Sandstorm Sentinel", "a man. He is wearing light, tan garments for desert heat and a sand-resistant curved sword sheathed at his side. A leather-wrapped shield completes his gear, ready to endure the harsh conditions of the arid landscape. Suddenly he looks at you. He sees you, what will you do, after all he is a threat!", 2, 1, 10,2,1,3);
    ...
    private static VillainBoss villainBoss = new VillainBoss("The Boss", "The fight is not over yet. Behind you, you feel a presence. It gives you shivers down your spine. A man in black armour wearing a mask looking right at you. He does not speak but he pulls his sword out and points it towards you. His intentions are clear. Remember, the only way home is the way trough.", 0, 0,15,3,3,2);
        ...
        while (true) {
            ...
            switch (userCommand.toLowerCase(Locale.ROOT)) {
                ...
                case "drink compound potion":
                    if (hero.getHealthPoints() < 10 && hero.getStaminaPoints() < 10){
                        hero.consumePotion(compoundPotion, hero);
                        hero.remove(compoundPotion);
                        hero.displayStats();
                    }else if (hero.getHealthPoints() == 10 && hero.getStaminaPoints() < 10){
                        hero.consumePotion(compoundPotion, hero);
                        hero.remove(compoundPotion);
                        hero.displayStats();
    ...
    public static void wantPotion() {
        ...
        System.out.println("You may choose from three different types of potions.\n" +
                ...
                "2. Stamina Poiton (Restore stamina )\n" +
